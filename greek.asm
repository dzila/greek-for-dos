...
; //------------------------------------------ ΚΛΗΘΗΚΕ Η ΔΙΑΚΟΠΗ INT 10H --//

   A00:	CMP	AH	,0		; Αν υφίσταται αλλαγή ανάλυσης
	JNZ	A01			; αποθήκευση του pointer επιστροφής
	PUSHF
	PUSH	CS
	DB	104
	DW	Offset A02+256
   ...
   A02:	PUSH	BX			; Εύρεση της ανάλυσης των χαρακτήρων
